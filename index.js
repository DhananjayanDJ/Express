...
// mongodb+srv://Dhananjayan:<password>@cluster0.r6f9fsc.mongodb.net/?retryWrites=true&w=majority

const MONGO_URL ="mongodb+srv://Dhananjayan:Iceakkadj3199@cluster0.r6f9fsc.mongodb.net"
...
//    }
    ...
    const movie = await client.db("mongo").collection("movies").find( request.query).toArray();
    response.send(movie);
});
...
app.post("/movies", async (request,response)=>{
  ...
  const result = await client.db("mongo").collection("movies").insertMany(newMovies);
